...
render() {
  if (!this.state.fontsLoaded) {
    ...
    return (
      <View style={this.state.light_theme ? stlyes.containerLight :styles.container}>
        ...
        <View style={styles.screenContainer}>
          <View style={styles.profileImageContainer}>
            ...
            ></Image>
            <Text style={this.state.light_theme ? styles.nameTextLight:stlyes.nameText}>{this.state.name}</Text>
          </View>
